...
export default class ManageJob extends React.Component {
    ...
    loadData(callback) {
        ...
        var link = 'https://mvplisting.azurewebsites.net/listing/listing/getSortedEmployerJobs';
        ...
        $.ajax({
            /*url: 'http://mvplisting.azurewebsites.net/listing/listing/getSortedEmployerJobs',*/
            url: requestUrl,
            headers: {
    ...
    closeJob(jobId) {
        ...
        $.ajax({
            url: 'https://mvplisting.azurewebsites.net/listing/listing/closeJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
